## 안녕하세요! 프로덕트로 말하는 개발자 송재민입니다. 👋

### 프로덕트에 맞는 최적의 설계를 고민합니다.

서비스 특성을 고려한 기술 선택을 중요하게 생각합니다. 

예를 들어, '스펙 랭킹' 프로젝트에서 무한 스크롤 구현 시 커서 페이지네이션으로 스펙 중복 문제를 해결했고, 부하가 예상되는 랭킹 시스템에서는 Redis 캐싱과 PER 알고리즘으로 조회 성능을 97.7% 향상시키며 DB 부하를 감소 시켰습니다. 

앞으로도 각 기술의 트레이드오프를 고려하며 서비스에 있어 최선의 선택을 하려고 합니다!
...
[![Portfolio](https://img.shields.io/badge/Portfolio-007ACC?style=for-the-badge&logo=adobeacrobatreader&logoColor=white)](https://www.canva.com/design/DAG1ZDlqO-4/ndhNiqaENeSTKkd6nSPZAQ/edit?utm_content=DAG1ZDlqO-4&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton)
...
| 회사명 | 기간 | 포지션 | 비고 |
|----------|------|-------|-------|
| 카카오뱅크 | 2026.01 ~ | 서버 개발 | 정규직 |
| 마이다스아이티 | 2025.12 | 백엔드 개발 | 채용연계형 인턴 (중도 포기) |

## 🚀 Projects

| 프로젝트명 | 기간 | 핵심 경험 | 포지션 |
|----------|------|------|-------|
| [SpecRanking](https://github.com/100-hours-a-week/19-Respec-BE) | 2025.05 ~ 2025.06 | 분산 환경에서 동작하는 Chat Server 구축, RankingBoard 성능 개선 | 풀스택 |
| [DevTalk](https://github.com/100-hours-a-week/2-jelly-song-community)  | 2025.03 ~ 2025.03 | 퍼블리싱 라이브러리 개발 후 활용, 보안성을 고려한 Auth 구축 | 풀스택 |
...
| 프로그램 | 기간 | 설명 | 직책 |
|----------|------|------|-------|
| Samsung SW·AI Academy For Youth (싸피) | 2025.07.08 ~ 2025.11.26 | 삼성 주관 소프트웨어 교육 | 교육생 | 
| [카카오 테크 부트캠프 2기](https://github.com/100-hours-a-week/2-jelly-song) | 2025.01.20 ~ 2025.07.07 | 풀스택 과정, 실 사용자 200명 서비스 [스펙랭킹](https://github.com/100-hours-a-week/19-Respec-BE) 런칭 | 교육생 |
